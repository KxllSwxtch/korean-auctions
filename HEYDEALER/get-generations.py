...
headers = {
    ...
    # 'Cookie': '_ga=GA1.2.225253972.1750804665; _gid=GA1.2.607092972.1750804665; ga_dsi=2f27c9738d9441acb3019f0388816973; csrftoken=oF1QX8pojFyAYw9J9yYO3JZgEHkxNEzB; sessionid=9kr7h1uvkd0y7dqjq3tlrbptgsd1jxi2; _gat=1; _ga_D0D36Y0VSC=GS2.2.s1750804665$o1$g1$t1750805516$j60$l0$h0',
}
...
response = requests.get(
    "https://api.heydealer.com/v2/dealers/web/car_meta/model_groups/rk0Jmy/",
    params=params,
    cookies=cookies,
    headers=headers,
)
