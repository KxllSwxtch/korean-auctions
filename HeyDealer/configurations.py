...
cookies = {
    ...
    "_gat": "1",
    "_ga_D0D36Y0VSC": "GS2.2.s1752034628$o8$g1$t1752034831$j60$l0$h0",
}
...
response = requests.get(
    "https://api.heydealer.com/v2/dealers/web/car_meta/models/o2QMk3/",
    params=params,
    cookies=cookies,
    headers=headers,
)
