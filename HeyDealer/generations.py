...
cookies = {
    ...
    "_gat": "1",
    "_ga_D0D36Y0VSC": "GS2.2.s1752034628$o8$g1$t1752034803$j18$l0$h0",
...
response = requests.get(
    "https://api.heydealer.com/v2/dealers/web/car_meta/model_groups/aMKrwk/",
    params=params,
    cookies=cookies,
    headers=headers,
)
